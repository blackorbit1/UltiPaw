...
public class VersionActions
{
    ...
    private IEnumerator FetchVersionsCoroutine()
    {
        ...
        string url = $"{UltiPawUtils.SERVER_BASE_URL}{UltiPawUtils.VERSION_ENDPOINT}?d={editor.currentBaseFbxHash}&t={editor.authToken}";
    ...
    private IEnumerator DownloadVersionCoroutine(UltiPawVersion version, bool applyAfter)
    {
        ...
        string url = $"{UltiPawUtils.SERVER_BASE_URL}{UltiPawUtils.MODEL_ENDPOINT}?version={version.version}&d={editor.currentBaseFbxHash}&t={editor.authToken}";
